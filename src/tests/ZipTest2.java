...
public class ZipTest2 {
    static String output = "C:\\Modding\\Useful Saves\\run\\backups";

    static String source1 = "C:\\Modding\\Useful Saves\\run\\saves\\le cul";
    static String source2 = "C:\\Modding\\Useful Saves\\run\\logs";

    public static void main(String[] args) throws IOException {
        zipDirs(output, "test.zip", true, f -> true,
                source1, source2);
    }
